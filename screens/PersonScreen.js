  ...
  return(
    <ScrollView className="bg-neutral-900 flex-1" contentContainerStyle={{paddingBottom: 20}}>
      ...
      <View>
        ...
        <View className="mt-6">
          <Text className="text-3xl text-white font-bold text-center">Keenu Reeves </Text>
          <Text className="text-base text-neutral-500  text-center">London United Kingdom </Text>
        </View>
        <View className="mx-3 mt-6 flex-row justify-between items-center border-neutral-700 rounded-full">
          ...
          <View className="border-r-2 border-neutral-400 items-center">
            <Text className="text-white font-semibold">Popularly </Text>
        ...
        <View className="my-6 mx-4 space-y-2">
          ...
          <Text className="text-neutral-400 tracking-wide ">
            Keenu Charles is Canadian actor. Reeves is known for his roles in Bill </Text>
        </View>
         {/* movies*/}
